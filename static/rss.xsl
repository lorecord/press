      ...
      <body>
        ...
        <xsl:for-each select="/rss/channel/item">
          <div class="item inner">
            ...
            <xsl:if test="itunes:subtitle">
              <p><xsl:value-of select="itunes:subtitle" /></p>
            </xsl:if>
            <xsl:if test="itunes:duration">
        ...
        <div class="foot">
          ...
          <nav>
            <a>
              <xsl:attribute name="href">
                <xsl:value-of select="/rss/channel/docs"/>
              </xsl:attribute>
              Docs
            </a>
          </nav>
          <span class="item_meta"><xsl:value-of select="/rss/channel/lastBuildDate"/></span>
        </div>
      </body>
    </html>
  </xsl:template>
